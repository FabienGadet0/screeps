...
// export abstract class ICreep implements Mnemonic {
//     name: string;
...
//         this.spawn_name = this.locator().spawn_name;
...
//         this.source_to_target = this.locator().source_to_target;
...
//         return Game.creeps[this.name].memory;
//     }
...
//             Memory.rooms_new[this.creep.room.name].cripple_creeps.push(this.name);
//         }
...
//             this.set(ACTION.WAITING_NEXT_TASK, undefined);
//             Memory.rooms_new[this.creep.room.name].cripple_creeps.remove(this.name);
//         }
//     }
