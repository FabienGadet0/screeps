...
export const roles_settings: Record<number, Record<string, role_setting>> = {
    ...
    1300: {
        harvester: {
            ...
            spawn_priority: SPAWN_IMPORTANCE.VERY_HIGH,
            limit: 2,
            body_part: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY],
        },
        builder: {
            source: 1,
            spawn_priority: SPAWN_IMPORTANCE.HIGH,
        ...
        upgrader: {
            ...
            spawn_priority: SPAWN_IMPORTANCE.MID,
            limit: 3,
            body_part: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY],
        },
    },
        1800: {
        harvester: {
            ...
            spawn_priority: SPAWN_IMPORTANCE.VERY_HIGH,
            limit: 2,
            body_part: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY],
        },
        builder: {
            source: 1,
            spawn_priority: SPAWN_IMPORTANCE.HIGH,
        ...
        upgrader: {
            ...
            spawn_priority: SPAWN_IMPORTANCE.MID,
            limit: 2,
            body_part: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY],
        },
    }
};
