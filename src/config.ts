...
//TODO do limit per role per room lvl.
...
export let role_to_bodyparts: Record<number, Record<string, BodyPartConstant[]>> = {
    ...
    1300: {
        ...
        upgrader: [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY],
    },
};
